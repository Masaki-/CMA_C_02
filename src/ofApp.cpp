...
void ofApp::draw(){
    ...
    
    {
        ...
        for (int i=0; i<=300; i=i+10){
            switch (stage_mode) { case 0:
                    ofSetColor(ofRandom(255),ofRandom(255),ofRandom(255));
                    break;
                case 1:
               ofSetColor(255*pow(sin(ofMap((float)ofGetElapsedTimeMillis(),
               0, 60000.0/132, 0, PI)+(double)i*PI/600),2));
                    break;
                    
                case 2:
                    ofSetColor(ofRandom(105),ofRandom(55),ofRandom(25));
                    break;
                default:
                break;
        ...
        for (int i = 0; i < 3600; i = i + 2) {
            ...
            ofSetColor(ofColor::fromHsb(25*pow(sin((float)ofGetElapsedTimeMillis()
            /1000+((float)i*PI/600)),2),5,255));
